...
const formSchema = z.object({
	...
	coef_q: z.number({ invalid_type_error: 'Вы ввели не число' }).nonnegative({ 'message': "Не может быть меньше 0" }),
	max_pressure: z.number({ invalid_type_error: 'Вы ввели не число' }).nonnegative({ 'message': "Не может быть меньше 0" })
})
